            ...
            while (true)
            {
                ...
                for (int i = 0; i < lineCount; i++)
                {
                    ...
                    for (int j = first; j <= last; j++)
                    {
                        ...
                        // Get the index of the material used by the gridSystemScript character.
                        ...
                        // Apply the matrix TRS to the individual characters relative to the center of the gridSystemScript line.
